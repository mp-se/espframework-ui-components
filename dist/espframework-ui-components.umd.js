(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.EspFrameworkUiComponents = {}, global.Vue));
  ...
  return (_ctx, _cache) => {
    return (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({ class: "card" }, _ctx.$attrs), [
      ...
      vue.createElementVNode("div", _hoisted_1$v, [
        vue.createElementVNode("h5", _hoisted_2$f, [
        ...
        vue.createElementVNode("p", _hoisted_3$b, [
    ...
    return (vue.openBlock(), vue.createBlock(_component_BsInputBase, {
      ...
      default: vue.withCtx(() => [
        vue.createElementVNode("div", _hoisted_1$u, [
          ...
          }, vue.toDisplayString(button.value), 9 /* TEXT, PROPS */, _hoisted_2$e),
          vue.createElementVNode("ul", _hoisted_3$a, [
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(options.value, (o) => {
              return (vue.openBlock(), vue.createElementBlock("li", {
                ...
                }, vue.toDisplayString(o.label), 9 /* TEXT, PROPS */, _hoisted_4$5)
              ]))
            }), 128 /* KEYED_FRAGMENT */))
          ])
        ])
      ...
      default: vue.withCtx(() => [
        vue.createElementVNode("div", _hoisted_1$q, [
          ...
          (unit.value !== undefined)
            ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_3$8, vue.toDisplayString(unit.value), 1 /* TEXT */))
            : vue.createCommentVNode("v-if", true)
        ])
      ]),
      _: 1 /* STABLE */
    ...
    return (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
      ...
      vue.createElementVNode("div", {
        ...
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(contextMenuOptions.value, (o) => {
          ...
          }, vue.toDisplayString(o.label), 9 /* TEXT, PROPS */, _hoisted_2$a))
        }), 128 /* KEYED_FRAGMENT */))
      ])
    ], 64 /* STABLE_FRAGMENT */))
  }
        ...
        vue.createElementVNode("div", _hoisted_1$l, [
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(options.value, (o) => {
            return (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
              ...
              }, vue.toDisplayString(o.label), 9 /* TEXT, PROPS */, _hoisted_3$7)
            ], 64 /* STABLE_FRAGMENT */))
          }), 128 /* KEYED_FRAGMENT */))
        ])
      ]),
  ...
  return (_ctx, _cache) => {
    return (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
      ...
      (dismissable.value && close.value !== undefined)
        ...
        : vue.createCommentVNode("v-if", true),
      (dismissable.value && close.value === undefined)
        ? (vue.openBlock(), vue.createElementBlock("button", _hoisted_1$e))
        : vue.createCommentVNode("v-if", true)
    ], 16 /* FULL_PROPS */))
  }
  }
  ...
  return (_ctx, _cache) => {
    return (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
      ...
      }), vue.toDisplayString(button.value), 17 /* TEXT, FULL_PROPS */, _hoisted_1$d),
      vue.createElementVNode("div", {
        id: 'modal' + _ctx.$.uid,
            ...
            vue.createElementVNode("div", _hoisted_7$3, [
              ...
              (jsonError.value != '')
                ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_9$2, [
                    ...
                    vue.createElementVNode("p", _hoisted_10$2, vue.toDisplayString(jsonError.value), 1 /* TEXT */)
                  ]))
                : vue.createCommentVNode("v-if", true)
            ]),
                      ...
                      vue.createElementVNode("div", _hoisted_3$2, [
                          vue.createElementVNode("div", _hoisted_4$1, [
                              vue.createElementVNode("div", _hoisted_5$1, [
                                  vue.createElementVNode("h1", _hoisted_6$1, vue.toDisplayString(__props.disabled ? 'Processing...' : __props.title), 1)
                              ]),
                              vue.createElementVNode("div", _hoisted_7$1, [
                                  (__props.message)
                                      ? (vue.openBlock(), vue.createElementBlock("p", _hoisted_8$1, vue.toDisplayString(__props.message), 1))
                                      : vue.createCommentVNode("v-if", true),
  ...
  class HttpClient {
      constructor() {
          if (typeof ({ url: (typeof document === 'undefined' && typeof location === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : typeof document === 'undefined' ? location.href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('espframework-ui-components.umd.js', document.baseURI).href)) }) !== 'undefined' &&
              undefined &&
  ...
  exports.BsModalLogin = script$e;
  exports.BsModalSelect = script$d;
  ...
  exports.volumeCLtoUKOZ = volumeCLtoUKOZ;
  exports.volumeCLtoUSOZ = volumeCLtoUSOZ;
  exports.volumeUKOZtoCL = volumeUKOZtoCL;
  exports.volumeUSOZtoCL = volumeUSOZtoCL;
  exports.weightKgToLbs = weightKgToLbs;
  exports.weightLbsToKg = weightLbsToKg;
